...
# Suhas Rao Tamvada
[suhas@tamvada.me](mailto:suhas@tamvada.me) \| [LinkedIn](https://www.linkedin.com/in/suhastamvada/) \| [Google Scholar](https://scholar.google.com/citations?hl=en&user=oQHSsp4AAAAJ) \| San Jose, CA


---

Mechanical Design Engineer focused on **thermal–fluid systems, electronics cooling, and hardware development** across power electronics and data center cooling. Blend of applied research (multiphase heat transfer + CHF physics), product-minded engineering, and hands-on design/validation.
...
**Tesla** — Palo Alto, CA  
**Mechanical Design Engineer** — *Jan 2025 – Present*  
- Own mechanical design and integration for hardware components, balancing **thermal, structural, manufacturability, and reliability** constraints.  
- Drive design from concept → CAD → tolerance/GD&T → release, partnering with cross-functional teams (EE, thermal, manufacturing, test).  
- Support validation via test/bring-up, root-cause analysis, and iterative design improvements.

**University of Florida, Mechanical & Aerospace Engineering** — Gainesville, FL  
**Postdoctoral Associate** — *May 2024 – Jan 2025*  
- Led a team of 5 graduate students and a Post-Doctoral researcher to develop direct-to-chip phase change cooling technology for data centers, successfully bringing technology readiness level (TRL) from 3 to 6.  
- Collaborated with engineering, manufacturing, and reliability teams to develop scalable packaging processes.  
- Performed techno-economic analyses (TEA) to assess commercialization feasibility of heat sinks.

**Graduate Research Assistant** — *Aug 2020 – May 2024*  
...
**Airity Technologies (Advanced Energy)** — Redwood City, CA  
...
**University of Illinois at Chicago, Mechanical & Industrial Engineering** — Chicago, IL  
**Graduate Research Assistant** — *Jan 2018 – Mar 2020*  
...
**Satyam Venture Engineering Services, BMW Division** — Hyderabad, India  
**Design Intern** — *Nov 2016 – May 2017*  
...
**Ph.D, Mechanical Engineering**, University of Florida, Gainesville, FL — *May 2024*  
Thesis: *Physics of Critical Heat Flux — Answers to Century Old Questions and New Discoveries*

**M.S, Mechanical Engineering**, University of Illinois at Chicago, Chicago, IL — *Jan 2020*  
Thesis: *Partial Coalescence of Oil and Water: Spreading Behavior and Material Synthesis*

**B.Tech, Mechanical Engineering**, Jawaharlal Nehru Technological University, Hyderabad, India — *May 2017*  
